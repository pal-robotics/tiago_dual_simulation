...
def declare_launch_arguments(launch_description: LaunchDescription):
    ...
    launch_description.add_action(robot_name_arg)
    ...
    launch_description.add_action(laser_model_arg)

    public_sim_arg = DeclareLaunchArgument(
        name='public_sim',
        default_value=False,
        description='Use the public simulation'
    )
    launch_description.add_action(public_sim_arg)
    ...
    launch_description.add_action(navigation_arg)
    ...
    launch_description.add_action(moveit_arg)
...
def declare_actions(launch_description: LaunchDescription):
    ...
    launch_description.add_action(SetEnvironmentVariable('GAZEBO_MODEL_PATH', model_path))
